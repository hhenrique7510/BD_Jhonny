...
export default function EditFuncionario() {
    ...
    const loadFuncionario = async () => {
        const result = await axios.get(`http://localhost:8080/funcionario/${cpf}`);
        setFuncionario(result.data);
    }

    const { celular, nome, senha, emailPrincipal, bairro, salario, rua, numero, cep, emailSecundario } = funcionario;
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`http://localhost:8080/funcionarioUpdate/${cpf}`, data, {
                headers: {
                ...
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="mb-3">
                        ...
                        <input
                            ...
                            value={numero}
                            onChange={(e) => onInputChange(e)}
                            placeholder="Número da residência do funcionário"
                        />
                    </div>
                    <div className="mb-3">
